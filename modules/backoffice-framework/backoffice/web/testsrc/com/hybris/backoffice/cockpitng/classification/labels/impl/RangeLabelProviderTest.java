...
public class RangeLabelProviderTest
{
	...
	@Test
	public void shouldProvideLabelWithEmptyRangeWhenStartAndEndAreNull()
	{
		// given
		...
		// then
		assertThat(resultLabel).isEqualTo(
				String.format(RANGE_LABEL_PATTERN, RANGE_FROM_LABEL, StringUtils.EMPTY, RANGE_TO_LABEL, StringUtils.EMPTY));
	}
