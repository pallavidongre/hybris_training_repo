...
public class DefaultNendrasysPaymentService implements NendrasysPaymentService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultNendrasysPaymentService.class);
	...
	{
		return DefaultNendrasysPaymentService.class.getResourceAsStream("/nendrasysPayment/sap-hybris-platform.png");
	}
