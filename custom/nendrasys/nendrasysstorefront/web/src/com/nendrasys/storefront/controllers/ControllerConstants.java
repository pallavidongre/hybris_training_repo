 ...
 */
package com.nendrasys.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String LatestProducts = _Prefix + LatestProductCmsComponentModel._TYPECODE + _Suffix; // NOSONAR
		}
	}
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface Product // NOSONAR
			{
				...
				String ProductRegistrationForm="/pages/product/productRegistrationForm";
				String CustomJsp="/pages/customJsp/newJsp";
			}
