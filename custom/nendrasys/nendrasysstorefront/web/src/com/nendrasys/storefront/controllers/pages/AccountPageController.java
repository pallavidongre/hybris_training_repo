...
public class AccountPageController extends AbstractSearchPageController
{
	...
	public CustomAddressValidator getCustomAddressValidator() {
		return customAddressValidator;
	}

	public void setCustomAddressValidator(CustomAddressValidator customAddressValidator) {
		this.customAddressValidator = customAddressValidator;
	}

	public CustomAddressDataUtil getCustomAddressDataUtil() {
		return customAddressDataUtil;
	}

	public void setCustomAddressDataUtil(CustomAddressDataUtil customAddressDataUtil) {
		this.customAddressDataUtil = customAddressDataUtil;
	}
	...
	@RequireHardLogIn
	public String addAddress(@ModelAttribute("addressForm") final CustomAddressForm addressForm, final BindingResult bindingResult, final Model model,
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		getCustomAddressValidator().validate(addressForm, bindingResult);
		if (bindingResult.hasErrors())
		{
			GlobalMessages.addErrorMessage(model, FORM_GLOBAL_ERROR);
			final ContentPageModel addEditAddressPage = getContentPageForLabelOrId(ADD_EDIT_ADDRESS_CMS_PAGE);
		...
		final AddressData newAddress = customAddressDataUtil.convertToVisibleAddressData(addressForm);
