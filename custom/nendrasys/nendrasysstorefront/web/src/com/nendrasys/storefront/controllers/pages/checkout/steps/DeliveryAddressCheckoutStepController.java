 ...
 */
package com.nendrasys.storefront.controllers.pages.checkout.steps;

import com.nendrasys.storefront.forms.CustomAddressForm;
import com.nendrasys.storefront.forms.validator.CustomAddressValidator;
import com.nendrasys.storefront.util.CustomAddressDataUtil;
...
public class DeliveryAddressCheckoutStepController extends AbstractCheckoutStepController
{
	...
	private AddressValidator customAddressValidator;
	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		populateCommonModelAttributes(model, cartData, new CustomAddressForm());
	...
	@RequireHardLogIn
	public String add(final CustomAddressForm addressForm, final BindingResult bindingResult, final Model model,
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		final AddressData newAddress = customAddressDataUtil.convertToAddressData(addressForm);
...
/*
		...
		final CustomAddressForm customaddressForm = new CustomAddressForm();
		final boolean hasCustomAddressData = addressData != null;
		if (hasCustomAddressData)
		{
			customAddressDataUtil.convert(addressData, customaddressForm);
		}


		final CartData cartData = getCheckoutFacade().getCheckoutCart();
		populateCommonModelAttributes(model, cartData,customaddressForm );
	...
	@RequireHardLogIn
	public String edit(final CustomAddressForm addressForm, final BindingResult bindingResult, final Model model,
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
	...
	public String doSelectSuggestedAddress(final AddressForm addressForm, final RedirectAttributes redirectModel)
	{
		...
		final AddressData selectedAddress = customAddressDataUtil.convertToAddressData(addressForm);
	...
	protected void populateCommonModelAttributes(final Model model, final CartData cartData, final CustomAddressForm addressForm)
