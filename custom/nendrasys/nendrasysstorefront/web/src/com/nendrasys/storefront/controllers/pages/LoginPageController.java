...
import com.nendrasys.storefront.controllers.CustomerRegistrationIsBussinessuser.CustomerRegistrationForm;
...
public class LoginPageController extends AbstractLoginPageController
{
	...
	public String doRegister(@RequestHeader(value = "referer", required = false) final String referer, final CustomerRegistrationForm form,
												...
												final RedirectAttributes redirectModel) throws CMSItemNotFoundException // NOSONAR
	{
		...
		CustomerRegistrationForm customRegisterForm= (CustomerRegistrationForm) form;
		...
		data.setIsBussinessUser(customRegisterForm.isIsBussinessUser());
		try
		{
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(new GuestForm());
		model.addAttribute(new CustomerRegistrationForm());
