...
<form:form method="post" modelAttribute="customerRegistrationForm" action="${action}">
	...
	<formElement:formPasswordBox idKey="register.checkPwd"
		...
		mandatory="true" />
	<formElement:formCheckbox idKey="customRegistration" labelKey="isBusinessUser" path="isBussinessUser" />
