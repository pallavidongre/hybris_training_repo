...
public class NendrasysCustomerFacade extends DefaultCustomerFacade {
    ...
    protected void setCommonPropertiesForRegister(final RegisterData registerData, final CustomerModel customerModel)
    {
        ...
        customerModel.setIsBusinessUser(registerData.getIsBussinessUser());
        System.out.println( "flag::"+registerData.getIsBussinessUser());
    }
