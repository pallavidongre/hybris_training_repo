...
public class CustomerModel extends UserModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Customer.newCustomer</code> attribute defined at extension <code>nendrasyscore</code>. */
	public static final String NEWCUSTOMER = "newCustomer";
	
	/** <i>Generated constant</i> - Attribute key of <code>Customer.isBusinessUser</code> attribute defined at extension <code>nendrasyscore</code>. */
	 ...
	 * @param _isBusinessUser initial attribute declared by type <code>Customer</code> at extension <code>nendrasyscore</code>
	...
	public CustomerModel(final Boolean _isBusinessUser, final boolean _loginDisabled, final String _uid)
	{
		super();
		setIsBusinessUser(_isBusinessUser);
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public CustomerModel(final Collection<CustomerReviewModel> _customerReviews, final Boolean _isBusinessUser, final boolean _loginDisabled, final ItemModel _owner, final String _uid)
	{
		super();
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.isBusinessUser</code> attribute defined at extension <code>nendrasyscore</code>. 
	 * @return the isBusinessUser
	 */
	@Accessor(qualifier = "isBusinessUser", type = Accessor.Type.GETTER)
	public Boolean getIsBusinessUser()
	{
		return getPersistenceContext().getPropertyValue(ISBUSINESSUSER);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.newCustomer</code> attribute defined at extension <code>nendrasyscore</code>. 
	 * @return the newCustomer
	 */
	@Accessor(qualifier = "newCustomer", type = Accessor.Type.GETTER)
	public Boolean getNewCustomer()
	{
		return getPersistenceContext().getPropertyValue(NEWCUSTOMER);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Customer.isBusinessUser</code> attribute defined at extension <code>nendrasyscore</code>. 
	 *  
	 * @param value the isBusinessUser
	 */
	@Accessor(qualifier = "isBusinessUser", type = Accessor.Type.SETTER)
	public void setIsBusinessUser(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(ISBUSINESSUSER, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Customer.newCustomer</code> attribute defined at extension <code>nendrasyscore</code>. 
	 *  
	 * @param value the newCustomer
	 */
	@Accessor(qualifier = "newCustomer", type = Accessor.Type.SETTER)
	public void setNewCustomer(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(NEWCUSTOMER, value);
	}
