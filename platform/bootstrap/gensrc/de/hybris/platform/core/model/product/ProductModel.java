...
public class ProductModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Product.customSEO</code> attribute defined at extension <code>nendrasyscore</code>. */
	public static final String CUSTOMSEO = "customSEO";
	
	/** <i>Generated constant</i> - Attribute key of <code>Product.customSEOKeyword</code> attribute defined at extension <code>nendrasyscore</code>. */
	public static final String CUSTOMSEOKEYWORD = "customSEOKeyword";
	
	/** <i>Generated constant</i> - Attribute key of <code>Product.manufactureDetails</code> attribute defined at extension <code>nendrasyscore</code>. */
	public static final String MANUFACTUREDETAILS = "manufactureDetails";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.customSEO</code> attribute defined at extension <code>nendrasyscore</code>. 
	 * @return the customSEO
	 */
	@Accessor(qualifier = "customSEO", type = Accessor.Type.GETTER)
	public String getCustomSEO()
	{
		return getPersistenceContext().getPropertyValue(CUSTOMSEO);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.customSEOKeyword</code> attribute defined at extension <code>nendrasyscore</code>. 
	 * @return the customSEOKeyword
	 */
	@Accessor(qualifier = "customSEOKeyword", type = Accessor.Type.GETTER)
	public String getCustomSEOKeyword()
	{
		return getPersistenceContext().getPropertyValue(CUSTOMSEOKEYWORD);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.manufactureDetails</code> attribute defined at extension <code>nendrasyscore</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the manufactureDetails
	 */
	@Accessor(qualifier = "manufactureDetails", type = Accessor.Type.GETTER)
	public List<ManufactureDetailsModel> getManufactureDetails()
	{
		return getPersistenceContext().getPropertyValue(MANUFACTUREDETAILS);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.customSEO</code> attribute defined at extension <code>nendrasyscore</code>. 
	 *  
	 * @param value the customSEO
	 */
	@Accessor(qualifier = "customSEO", type = Accessor.Type.SETTER)
	public void setCustomSEO(final String value)
	{
		getPersistenceContext().setPropertyValue(CUSTOMSEO, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Product.customSEOKeyword</code> attribute defined at extension <code>nendrasyscore</code>. 
	 *  
	 * @param value the customSEOKeyword
	 */
	@Accessor(qualifier = "customSEOKeyword", type = Accessor.Type.SETTER)
	public void setCustomSEOKeyword(final String value)
	{
		getPersistenceContext().setPropertyValue(CUSTOMSEOKEYWORD, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.manufactureDetails</code> attribute defined at extension <code>nendrasyscore</code>. 
	 *  
	 * @param value the manufactureDetails
	 */
	@Accessor(qualifier = "manufactureDetails", type = Accessor.Type.SETTER)
	public void setManufactureDetails(final List<ManufactureDetailsModel> value)
	{
		getPersistenceContext().setPropertyValue(MANUFACTUREDETAILS, value);
	}
